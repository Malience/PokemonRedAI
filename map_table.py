_values='''000	0x00	Pallet Town	6
...
011	0x0B	Unused Fly location	1
012	0x0C	Route 1	7
013	0x0D	Route 2	15
014	0x0E	Route 3	15
015	0x0F	Route 4	15
...
063	0x3F	Poliwhirl for Jynx trade house
064	0x40	Pokémon Center (Cerulean City)	17
065	0x41	Gym (Cerulean City)	17
...
092	0x5C	Gym (Vermilion City)	17
...
105	0x69	Unused (Victory Road)	1D
106	0x6A	Unused (Victory Road)	1D
107	0x6B	Unused (Victory Road)	1D
108	0x6C	Victory Road (Route 23 entrance)	17
109	0x6D	Unused (Pokémon League)	1D
110	0x6E	Unused (Pokémon League)	1D
111	0x6F	Unused (Pokémon League)	1D
112	0x70	Unused (Pokémon League)	1D
113	0x71	Lance's Elite Four room	16
114	0x72	Unused (Pokémon League)	1D
115	0x73	Unused (Pokémon League)	1D
116	0x74	Unused (Pokémon League)	1D
117	0x75	Unused (Pokémon League)	1D
118	0x76	Hall of Fame	16
119	0x77	Underground Path (Route 5-Route 6)	18
120	0x78	Blue (Champion)'s room	1D
121	0x79	Underground Path (Route 7-Route 8)	18
122	0x7A	Celadon Department Store 1F	18
...
142	0x8E	Pokémon Tower 1F	18
143	0x8F	Pokémon Tower 2F	18
144	0x90	Pokémon Tower 3F	18
145	0x91	Pokémon Tower 4F	18
146	0x92	Pokémon Tower 5F	18
147	0x93	Pokémon Tower 6F	18
148	0x94	Pokémon Tower 7F	18
...
166	0xA6	Gym (Cinnabar Island)	1D
...
204	0xCC	Unused (Team Rocket Hideout)	1
205	0xCD	Unused (Team Rocket Hideout)	1
206	0xCE	Unused (Team Rocket Hideout)	1
...
226	0xE2	Cerulean Cave	11
227	0xE3	Cerulean Cave 1F	11
228	0xE4	Cerulean Cave B1F	1D
229	0xE5	Name Rater's house (Lavender Town)	7
230	0xE6	Cerulean City (Gym Badge man)	1D
231	0xE7	Unused (Rock Tunnel)	1
...
def _init_map_table():
    ...
    dct = {}
    for splt in _splits:
        dct[int(splt[:3])] = splt.split('\t')[2]
    return dct

map_table = _init_map_table()